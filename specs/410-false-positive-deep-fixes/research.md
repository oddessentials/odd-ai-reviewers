...
3. **Safe directory listings** (FR-003): `fs.readdirSync(safeArg)` where safeArg is constant or __dirname-relative. Check via ts.isCallExpression with safe argument tracing.
