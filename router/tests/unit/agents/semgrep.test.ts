...
import { semgrepAgent, mapSeverity } from '../../../src/agents/semgrep.js';
import type { AgentContext } from '../../../src/agents/types.js';
import { isSuccess, isFailure, isSkipped } from '../../../src/agents/types.js';
...
vi.mock('../../../src/agents/path-filter.js', () => ({
...
import { filterSafePaths } from '../../../src/agents/path-filter.js';
