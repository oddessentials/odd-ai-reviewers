...
} from '../../../../src/cli/dependencies/messages.js';
import type {
  DependencyCheckResult,
  DependencyCheckSummary,
} from '../../../../src/cli/dependencies/types.js';

// Mock platform detection
vi.mock('../../../../src/cli/dependencies/platform.js', () => ({
  detectPlatform: vi.fn().mockReturnValue('darwin'),
}));

import { detectPlatform } from '../../../../src/cli/dependencies/platform.js';
...
describe('message formatting', () => {
  ...
  describe('formatSkippedPassWarning', () => {
    ...
    beforeEach(async () => {
      const messages = await import('../../../../src/cli/dependencies/messages.js');
